...
while True:
        ...
        for i in range(len(sent)):
            if sent[i] in alpha_english_lower:
                ...
                try:
                    ...
                    sent_code += alpha_english_lower[
                        step - (len(alpha_english_lower) - position)
                    ]
                ...
                try:
                    ...
                    sent_code += alpha_english_upper[
                        step - (len(alpha_english_upper) - position)
                    ]
            else:
                sent_code += sent[i]
        ...
        for i in range(len(sent)):
            if sent[i] in alpha_russian_lower:
                ...
                try:
                    ...
                    sent_code += alpha_russian_lower[
                        step - (len(alpha_russian_lower) - position)
                    ]
                ...
                try:
                    ...
                    sent_code += alpha_russian_upper[
                        step - (len(alpha_russian_upper) - position)
                    ]
            else:
                sent_code += sent[i]
        ...
        for i in range(len(sent)):
            if sent[i] in alpha_english_lower:
                ...
                try:
                    ...
                    sent_code += alpha_english_lower[
                        len(alpha_english_lower) - (step - position)
                    ]
            elif sent[i] in alpha_english_upper:
                position = alpha_english_upper.find(sent[i])
                try:
        ...
        for i in range(len(sent)):
            if sent[i] in alpha_russian_lower:
                ...
                try:
                    ...
                    sent_code += alpha_russian_lower[
                        len(alpha_russian_lower) - (step - position)
                    ]
            elif sent[i] in alpha_russian_upper:
                position = alpha_russian_upper.find(sent[i])
                try:
    ...
    if answer.lower() == "шифровать":
        ...
        if answer.lower() == "стоп":  # Остановка программы.
            ...
            print(
                "Проверьте правильность введенного запроса!"
